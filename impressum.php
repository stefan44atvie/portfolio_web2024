  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php#myprojects">Projects</a>
        </li>
        <li class="nav-item">
...
<p>Stefan R&uuml;denauer<br />
WebDesign Digitale Seele<br />
Jedleseer Stra&szlig;e 4/2/5<br />
1210 Wien</p>

<h2>Kontakt</h2>
<p>Telefon: +436644342127<br />
E-Mail: office@digitaleseele.at</p>
